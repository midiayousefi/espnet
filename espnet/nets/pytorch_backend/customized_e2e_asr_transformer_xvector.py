...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def __init__(self, idim, odim, args, ignore_id=-1):
        ...
        self.xvector_dim = 512
        self.xvector_projection_layer = torch.nn.Linear(self.xvector_dim, args.adim)
    ...
    def forward(self, xs_pad, ilens, ys_pad, xvector):
        """E2E forward.
        ...
        #add xvector to encoder outputs
        projected_xvector = self.xvector_projection_layer(xvector)
        projected_xvector = projected_xvector.unsqueeze(1).repeat(1, hs_pad.shape[1], 1)
        hs_pad_xvec = hs_pad + projected_xvector 
        ...
        if self.decoder is not None:
            ...
            pred_pad, pred_mask = self.decoder(ys_in_pad, ys_mask, hs_pad_xvec, hs_mask)
